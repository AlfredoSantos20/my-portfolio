  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col-reverse md:flex-row items-center justify-center gap-10">
      <div className="flex-1 text-center md:text-left">
        <p data-aos="slide-right" className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-2">
          <Typewriter
        ...
        <h1 data-aos="slide-right" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 hover:bg-gradient-to-r from-cyan-400 to-blue-500 hover:bg-clip-text hover:text-transparent transition-colors duration-300">
          Back-end Developer
        </h1>

        <p data-aos="slide-right" className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-700 max-w-xl mx-auto md:mx-0">
      ...
      <div className="flex-1 flex justify-center">
        <div
          data-aos="slide-left"
          className="led-rgb-bg p-3 sm:p-4 rounded-3xl shadow-xl group max-w-[280px] sm:max-w-[340px] md:max-w-[400px] w-full"
        >
          <img
